...
<head>
    <jsp:include page="WEB-INF/views/partials/head.jsp">
        <jsp:param name="title" value="Privacy Policy - YourSmartHouse"/>
    </jsp:include>
    <style>
        h1,h2,h3{
            color: #464855;
...
<div class="content-wrap">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to YourSmartHouse.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to <a href="${pageContext.request.contextPath}/">YourSmartHouse</a></p>
        </li>
        <li>
    ...
    <h1>Contact Us</h1>
    <p>If you have any questions about this Privacy Policy, You can contact us by email: <a href="mailto:g.donisi1@studenti.unisa.it">g.donisi1@studenti.unisa.it</a> </p>
</div>
